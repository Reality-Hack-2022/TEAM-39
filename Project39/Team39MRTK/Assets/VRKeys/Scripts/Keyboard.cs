...
namespace VRKeys {
	...
	public enum KeyGroup {
		...
		RedLeft, RedRight,
		GreenLeft, GreenMiddle, GreenRight,
		BlueLeft, BlueRight,
		Default
	}
	...
	public class Keyboard : MonoBehaviour {
		...
		public KeyGroup currentKeyGroup = KeyGroup.GreenMiddle;
		...
		public void IndicatePress(int finger, bool left, bool right)
		{
			...
			Debug.Log($"Indicate press! " + keys.Length.ToString() + " " + finger.ToString() );
			foreach (LetterKey key in keys)
			{
		...
		public void IndicatePress() {
			Debug.Log($"Indicate press!"  + keys.Length.ToString());
			foreach (LetterKey key in keys) {
				if (key.keyGroup == currentKeyGroup) key.Indicate(true);
			}
		}
		*/
