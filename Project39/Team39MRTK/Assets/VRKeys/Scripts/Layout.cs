...
namespace VRKeys {
	...
	public class Layout {
		...
		*/
		...
		public string[] row1Keys = { "q", "w", "e", "r", "t", "y", "u", "i", "o"};

		public string[] row1Shift = { "Q", "W", "E", "R", "T", "Y", "U", "I", "O"};

		public string[] row2Keys = { "a", "s", "d", "f", "g", "h", "j", "k", "l"};

		public string[] row2Shift = { "A", "S", "D", "F", "G", "H", "J", "K", "L"};

		public string[] row3Keys = { "z", "x", "c", "v", "b", "n", "m", "p"};

		public string[] row3Shift = { "Z", "X", "C", "V", "B", "N", "M", "P"};
