...
namespace Microsoft.MixedReality.Toolkit.Examples
{
    ...
    public class GestureTester : MonoBehaviour, IMixedRealityGestureHandler<Vector3>
    {
        ...
        public void OnGestureStarted(InputEventData eventData)
        {
            ...
            //SetSlider(selectIndicator, "", defaultMaterial, eventData.InputData);
        }
        ...
        /*
        private void SetSlider(GameObject indicator, string label, Material material, Vector3 position)
        {
            if (indicator)
            {
                //var transform = indicator.GetComponent<Transform>();
                var pinchSlider = indicator.GetComponentInChildren<Microsoft.MixedReality.Toolkit.UI.PinchSlider>();
                ...
                if (text)
                {
                    text.text = pinchSlider.SliderValue.ToString("0.0000");
                }
            }
        }
        */
